...
static void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.BaudRate = 921600;								//suggestion: application specific bootloaders could try and retrieve comms settings from application persistence area and load that into the comms init!
