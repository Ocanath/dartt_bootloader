...
void test_write_buffer(void)
{
	...
	{//test case 4: working_size not a multiple of write_size
	...
	{//test case 5: write_size uninitialized
	...
	{//test case 6: write to bootloader region (blocked)
